...
LEAGUE_PROFILES: dict[str, LeagueProfile] = {
    "epl": LeagueProfile(
        name="英超", home_advantage=0.43, draw_rate=0.25,
        away_advantage=0.32, avg_goals=2.78, btts_rate=0.54,
        over_25_rate=0.53, volatility=0.45,
    ),
    "laliga": LeagueProfile(
        name="西甲", home_advantage=0.45, draw_rate=0.26,
        away_advantage=0.29, avg_goals=2.55, btts_rate=0.48,
        over_25_rate=0.48, volatility=0.40,
    ),
    "serie_a": LeagueProfile(
        name="意甲", home_advantage=0.41, draw_rate=0.28,
        away_advantage=0.31, avg_goals=2.52, btts_rate=0.50,
        over_25_rate=0.47, volatility=0.50,
    ),
    "bundesliga": LeagueProfile(
        name="德甲", home_advantage=0.44, draw_rate=0.23,
        away_advantage=0.33, avg_goals=3.05, btts_rate=0.57,
        over_25_rate=0.58, volatility=0.48,
    ),
    "ligue1": LeagueProfile(
        name="法甲", home_advantage=0.42, draw_rate=0.28,
        away_advantage=0.30, avg_goals=2.58, btts_rate=0.49,
        over_25_rate=0.49, volatility=0.47,
    ),
    "eredivisie": LeagueProfile(
        name="荷甲", home_advantage=0.44, draw_rate=0.23,
        away_advantage=0.33, avg_goals=3.20, btts_rate=0.60,
        over_25_rate=0.62, volatility=0.55,
    ),
}
